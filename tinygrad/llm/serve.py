...
class Handler(HTTPRequestHandler):
  ...
  def do_GET(self):
    if self.path == "/v1/models": self.send_data(json.dumps({"object":"list","data":[{"id":self.server.model_name,"object":"model",
      "context_length":self.server.model.max_context}]}).encode())
