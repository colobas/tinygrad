...
Define how the LLM server supports tool calling: accepting OpenAI tool definitions and tool-choice semantics, parsing model-generated tool calls from native syntax into OpenAI `tool_calls` (non-streaming and streaming), and keeping tool-call text out of the assistant content stream.
